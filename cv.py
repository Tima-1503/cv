...
# Функция предобработки кадра (преобразование в оттенки серого)
...
# Функция для обнаружения лиц на кадре
...
def main():
    ...
    while True:
        ...
        if not is_internet_available():
            # print("Internet connection not available. Waiting...")
            time.sleep(5)  # Ждем 5 секунд перед повторной проверкой
            continue

        # print("Internet connection available. Starting main loop.")
        ...
        # Здесь используем функцию detect_face для определения присутствия лица
